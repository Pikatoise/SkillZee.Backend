...
namespace SkillZee.Infrastructure.DAL.Migrations
{
    ...
    [Migration("20250115164747_HasDataForOrderSpeed")]
    partial class HasDataForOrderSpeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillZee.Domain.Entities.OrderResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SkillZee.Domain.Entities.OrderSpeed", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("019f5b79-1fe2-435d-99f3-837e38047036"),
                        ...
                        new
                        {
                            Id = new Guid("7d318e1a-cded-4481-b24b-77b385735245"),
                            CreatedAt = new DateTime(2025, 1, 15, 12, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            RewardMultiplier = 1.1000000000000001,
                            Title = "Срочно"
                        },
                        new
                        {
                            Id = new Guid("1a452389-4644-45af-be2c-359ceec260e5"),
                            CreatedAt = new DateTime(2025, 1, 15, 12, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
